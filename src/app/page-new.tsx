...
export default function HomePage() {
  const { isAuthenticated, currentUserRole, currentUserId, accessToken: authToken, loading: authLoading } = useAuth();
    ...
    const loadData = async () => {
      ...
      try {
        ...
        if (matchesResponse.data && leaguesResponse.data && teamsResponse.data && playersResponse.data) {
          ...
          availabilityResponses.forEach((response: ApiResponse<Record<string, boolean>>, index: number) => {
